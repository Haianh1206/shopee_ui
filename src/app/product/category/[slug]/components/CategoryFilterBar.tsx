...
export default function CategoryFilterBar() {
        ...
        <div className="w-full bg-[rgba(0,0,0,0.03)] sm:pb-20 border-b-[4px] border-red-500">
            <div className="sm:mx-40">
                <div className="flex min-h-screen">
                    ...
                    <main className="sm:w-5/6 p-2 sm:p-4">
                        <div className="hidden sm:flex items-center bg-[#00000008] px-4 py-3 space-x-3 mb-4">
    ...
    ${active === "popular"
                        ...
                        <span className="flex sm:hidden text-gray-500 text-lg">Gợi ý cho bạn</span>

                        <div className="grid grid-cols-2 sm:grid-cols-5 gap-2 sm:gap-3 pb-6">
                            {filteredProducts.map((product) => (
                                <div
                                    key={product.id}
                                    onClick={() => handleClick(product.id)}
                                    className="group relative flex flex-col bg-white 
  sm:border  sm:rounded-none border-gray-200
  transition-all duration-200 
  hover:-translate-y-[1px] overflow-visible pb-3 hover:z-50"
                                >
                                    {/* ảnh full width */}

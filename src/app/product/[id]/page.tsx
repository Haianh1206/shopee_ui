...
import { IoIosArrowForward, IoIosArrowBack } from "react-icons/io"; export default function ProductDetailPage() {
    ...
    return (
        <div className="w-full bg-[rgba(0,0,0,0.03)] -mt-[110px] pb-6">

            <div className="  max-w-6xl mt-26 pb-20 mx-40 pt-6">
                ...
                <div className=" bg-white h-[620px] p-4 flex flex-col md:flex-row gap-6">
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="relative flex items-center">
                            {/* Thumbnails hiển thị tối đa 5 ảnh */}
                        ...
                        {isModalOpen && product && (
                            ...
                            >
                                <div
                                    className="bg-white rounded-[2px] overflow-hidden flex w-[830px] h-[510px] relative shadow-lg"
                                    onClick={(e) => e.stopPropagation()} // Chặn click vào modal
                                >
                                    ...
                                    <div className="relative flex-1 flex items-center justify-center ">
                                        ...
                                        <button
                                            onClick={handlePrev}
                                            className="absolute left-3 text-white  bg-gray-500 text-4xl p-2  rounded-full z-10"
                                        >
                                            <IoIosArrowBack />
                                        </button>
                                        ...
                                        <button
                                            onClick={handleNext}
                                            className="absolute right-3 text-white bg-gray-500 text-4xl p-2 z-10"
                                        >
                                            <IoIosArrowForward />
                                        </button>
                                    </div>

                                    {/* Phần thông tin + thumbnails */}
